...
class Hamburger {
     ...
     */
    calculatePrice() {
        let pr = Hamburger.SIZES[this._size].price
        // let priceSize = Hamburger.SIZES[this._size].price;
        // let priceStuffing = Hamburger.STUFFINGS[this._stuffing].price;
        // let priceToppings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].price + acc, 0);
        // return priceSize + priceStuffing + priceToppings;
        console.log(pr);
    ...
    calculateCalories() {
        ...
        // let toppingCalories = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].calories + acc, 0);
        // return stuffingCalories + sizeCalories + toppingCalories;
    }
