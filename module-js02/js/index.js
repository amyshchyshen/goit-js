...
// do {
//   userPass = prompt('Введите, пожалуйста, ваш пароль');
...
//   }
//   limit -= 1;
//   if (limit !== 0 && !success && userPass !== null) {
//     alert(`Неверный пароль, у вас осталось ${limit} попыток`);
//   }
// } while (limit !== 0 && !success && userPass !== null);

// if (limit === 0 && !success && userPass !== null) {
//   alert('У вас закончились попытки, аккаунт заблокирован!');
// } else if (userPass === null) {
//   alert('Приходите к нам еще');
// }